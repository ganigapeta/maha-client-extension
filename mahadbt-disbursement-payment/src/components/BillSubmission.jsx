...
const BillSubmission = ({ apiRes, submittedBillList, setResponseData, setSubmittedBillList, generateRftOnly, billRowData }) => {  const [isAgreed, setIsAgreed] = useState(false);
