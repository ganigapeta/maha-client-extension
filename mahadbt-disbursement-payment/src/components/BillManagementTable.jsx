...
import { saveSelectedBeneficiarie, getBills, getDataBaseOnBillNumber } from "../api/save"; import BillSubmission from "./BillSubmission";
...
const BillManagementTable = ({ selectedBeneficiaries = [], apiRes, allocateInputData, isPensionRole = false, searchData }) => {
